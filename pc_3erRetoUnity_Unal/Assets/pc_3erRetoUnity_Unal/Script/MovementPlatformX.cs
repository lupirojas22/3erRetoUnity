...
public class MovementPlatformX : MonoBehaviour
{
    public float distanciaMaxima = 5.0f;   // Distancia máxima en el eje X
    ...
    void Start()
    {
        ...
        puntoB = new Vector3(transform.position.x + distanciaMaxima, transform.position.y, transform.position.z);
